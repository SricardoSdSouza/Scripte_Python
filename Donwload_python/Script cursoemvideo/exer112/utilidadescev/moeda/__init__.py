def aumentar(preco=0, taxa=0, formato=False):
    """
    -> Função que retorna o aumento de um determinado valor monetario formatado
    :param preco: valor a ser formatado
    :param taxa: percentual a ser adicionado
    :param formato: formata a moeda ou não
    :return: se falso não formata se true formata o valor reajustado
    """
